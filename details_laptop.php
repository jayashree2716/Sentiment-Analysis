      ...
      <div class="right-col">
        ...
        <div class="properties">
          <div class="prop">
            ...
            <p><?php echo htmlspecialchars($product['battery'] ?? 'HD Audio'); ?></p>
          </div>
          <div class="prop">
            <h4>Screen size</h4>
            <p><?php echo htmlspecialchars($product['display'] ?? '16.5-inch 1.5K AMOLED display with a 165Hz refresh rate'); ?></p>
          </div>
          <div class="prop">
            <h4>Processor</h4>
            <p><?php echo htmlspecialchars($product['cpu'] ?? 'Ryzen 5'); ?></p>
          </div>
          <div class="prop">
            <h4>RAM / Storage</h4>
            <p><?php echo htmlspecialchars(($product['ram'] ?? '8GB or 512GB') . ' / ' . ($product['storage'] ?? '256GB or 512GB UFS 4.1')); ?></p>
          </div>
          <div class="prop">
            <h4>Operating System</h4>
            <p><?php echo htmlspecialchars($product['camera'] ?? 'Windows 11 Home'); ?></p>
          </div>
        </div>
        ...
        <div class="section">
          ...
          <?php
            ...
            if (!empty($product['about'])) {
                ...
                echo '<p>The build of the laptop balances aesthetics with durability. The device uses a premium back finish and a reinforced frame to withstand daily use. Connectivity is modern and includes fast Wi-Fi, 5G support, and Bluetooth Low Energy. The software experience is optimised to help users get more done with dedicated productivity features and customizable gestures. Security features such as fingerprint unlock and face unlocking ensure convenience and safety. With an immersive audio system and smart power saving modes, the device fits both entertainment and productivity needs.</p>';
...
<a href="sentiment_graph.php?product_id=<?php echo $product_id; ?>">
    <button style="margin-top:10px;background:green;color:white;padding:8px 12px;border:none;border-radius:5px;cursor:pointer;position:relative;left:40px;bottom:30px;margin-bottom:30px">
